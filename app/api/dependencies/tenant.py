...
def get_request_tenant(
    ...
    tenant_id_token = tenant_id_var.set(tenant.id)
    tenant_slug_token = tenant_slug_var.set(tenant.slug)
    request.state.tenant_id = tenant.id
    request.state.tenant_slug = tenant.slug
    request.state.tenant_context_tokens = (tenant_id_token, tenant_slug_token)
